...
public class AbstractLogLogicTest {
   ...
   public void testGetCheckedOperationPresentInCache() throws NoSuchFieldException, IllegalAccessException, StressorException {
      BasicOperations.Cache cache = new TestUtils.BasicOperationsCache();
      AbstractLogLogic logic = createLogic(new GeneralConfiguration(), new LegacyLogicConfiguration(), new LogLogicConfiguration(), cache);
   ...
   public void testGetCheckedOperationNotPresentInCache() throws NoSuchFieldException, IllegalAccessException, StressorException {
      BasicOperations.Cache cache = new TestUtils.BasicOperationsCache();
      AbstractLogLogic logic = createLogic(new GeneralConfiguration(), new LegacyLogicConfiguration(), new LogLogicConfiguration(), cache);
   ...
   public void testGetCheckedOperationIgnoreDeadCheckers() throws NoSuchFieldException, IllegalAccessException, StressorException {
      BasicOperations.Cache cache = new TestUtils.BasicOperationsCache();
      LogLogicConfiguration llc = new LogLogicConfiguration();
      ...
      long result = logic.getCheckedOperation(logic.stressor.id, 20);

      assertEquals(result, Long.MIN_VALUE);
      assertEquals(cache.get(LogChecker.ignoredKey(0, logic.stressor.id)), null);
      assertEquals(cache.get(LogChecker.ignoredKey(1, logic.stressor.id)), null);
   }

   public void testGetCheckedOperationIgnoreDeadCheckersInitial1() throws NoSuchFieldException, IllegalAccessException, StressorException {
      BasicOperations.Cache cache = new TestUtils.BasicOperationsCache();
      LogLogicConfiguration llc = new LogLogicConfiguration();
      llc.ignoreDeadCheckers = true;
      GeneralConfiguration gc = new GeneralConfiguration();
   ...
   public void testGetCheckedOperationIgnoreDeadCheckersInitial2() throws NoSuchFieldException, IllegalAccessException, StressorException {
      BasicOperations.Cache cache = new TestUtils.BasicOperationsCache();
      LogLogicConfiguration llc = new LogLogicConfiguration();
      llc.ignoreDeadCheckers = true;
      GeneralConfiguration gc = new GeneralConfiguration();
      ...
      assertEquals(logic.getCheckedOperation(logic.stressor.id, 10l), 10l);
   }
