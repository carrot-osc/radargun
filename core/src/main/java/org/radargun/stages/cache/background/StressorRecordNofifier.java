 ...
 * @since 4.0
 */
public class StressorRecordNofifier implements CacheListeners.UpdatedListener, CacheListeners.CreatedListener {

   private static final Log log = LogFactory.getLog(StressorRecordNofifier.class);

   private BackgroundOpsManager manager;

   public StressorRecordNofifier(BackgroundOpsManager manager) {
